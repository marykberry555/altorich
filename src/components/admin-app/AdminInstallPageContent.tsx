...
import { Download, Shield, Share } from "lucide-react";
...
export function AdminInstallPageContent() {
  const { canInstall, promptInstall, isStandalone, showIosHelp, pushReady, subscribePush } = useAdminPwa();
      ...
      <div className="w-full max-w-md text-center">
          ...
          {canInstall ? (
            ...
            <div className="w-full rounded-xl border border-white/10 bg-zinc-900/80 px-4 py-4 text-left text-sm text-zinc-300">
              ...
              <ol className="mt-3 list-decimal space-y-1.5 pl-4 text-zinc-400">
                ...
                <li>Confirm to add Alto Rich Admin</li>
              </ol>
            </div>
          ) : (
            <div className="w-full rounded-xl border border-white/10 bg-zinc-900/80 px-4 py-4 text-left text-sm text-zinc-300">
              ...
              <ul className="mt-2 list-inside list-disc space-y-1 text-zinc-400">
                <li>
                  <strong className="text-zinc-200">Chrome / Edge / Samsung Internet:</strong> menu → Install app
                </li>
                <li>
        ...
        <div className="mt-10 rounded-2xl border border-white/10 bg-zinc-900/80 p-5 text-left">
          ...
          <p className="mt-2 break-all text-xs text-zinc-400">
            https://altorich.com{ADMIN_APP_INSTALL}
          </p>
