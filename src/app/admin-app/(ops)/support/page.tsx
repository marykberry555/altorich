    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-2 text-sm text-zinc-400">
          Member contact submissions are delivered to {COMPANY.supportEmail}. Monitor your operations inbox and Smartsupp for live conversations.
        </p>
      </header>
      <div className="rounded-xl border border-white/10 bg-zinc-900/80 p-5 text-sm text-zinc-300">
        ...
        <p className="mt-3">
          For in-app chat, use the Smartsupp operator dashboard linked to the production widget key.
        </p>
      </div>
    </div>
  );
